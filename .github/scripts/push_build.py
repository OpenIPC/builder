...
A copy of OpenIPC/firmware's .github/scripts/push_build.py, with
soc_aliases.py and test_push_build.py beside it. Change them there first and
copy them here. The builder pushes no aliases, because its devices build from
firmware's defconfigs, which firmware already reports.
